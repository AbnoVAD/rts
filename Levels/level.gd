...
var main_menu_scene=preload("res://Menus/Main menu.tscn")
...
func _update_objective_text() -> void:
	...
	if level_completed:
		objective_label.text = "Task complete. Hold the line or press Next."
	elif Global.current_wave >= Global.max_waves:
		objective_label.text = "Final objective: destroy all goblin houses."
